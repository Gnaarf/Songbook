...
\guitarchord{G}
\guitarchord{Fm}}
\strummingEightBeatsAndFourMovementsPerBeat{d.u...d.d.du.udud.du.udud.du.udu}
...
\begin{guitar}
	...
	Es ist aus, denn der Klo-Drow schlitzt mich auf.
	
	\begin{highlightbar}
		\songsection{Refrain} \songsnippet{Beim Pissen gemeuchelt, ... (... der Klo-Drow schlitzt mich auf.)}
	\end{highlightbar}
	\pagebreak
	\songsection{Strophe 3}
	Ich [Am]steh kurz vor dem Kampfe im [F]Harnisch auf dem [G]Feld,
	...
	\begin{highlightbar}
		\songsection{Refrain} \songsnippet{Beim Küssen gemeuchelt, ... (... da wär ich doch lie-ber...)}
	\end{highlightbar}
	...
	\begin{highlightbar}
		\songsection{Refrain}
		Beim Singen ge[Am]meuchelt, ich [F]lieg in meinem [G]Saft
		Beim Singen [Am]gemeuchelt, die Hand noch [F]am Gitarren[G]schaft
		Es ist [F]aus, denn ein [Fm]Ehemann schlitzt mich auf
	\end{highlightbar}
	
	\songsection{Strophe 6}
	Ich [Am]leide an Verstopfung und [F]hocke auf dem [G]Schacht
	...
	Es ist [F]aus, und die [Fm]Wurst ist noch nicht raus
	...
	\begin{highlightbar}
		\songsection{Refrain} \songsnippet{Beim Kacken versteinert, und unter mei’m Gewicht...}
	\end{highlightbar}
	...
	\begin{highlightbar}
		...
		Es ist aus, das Lied ist vorbei und wir sind raus.
	\end{highlightbar}
\end{guitar}