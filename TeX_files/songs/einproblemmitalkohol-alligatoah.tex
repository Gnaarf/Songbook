...
\input{./TeX_files/songs/songtabs/einproblemmitalkohol-alligatoah-tabs}
...
\begin{guitar}
	...
	[D] Graue Wände, die Gebäude hier sind kalt.
	[A]Lyrisch, wie ich bin, nenn' ich das häusliche Gewalt.
	[E]Woah, krass, große Poesie.
	[F#m]Ist das noch 'ne Songzeile oder schon ein Tweet?
	...
	\begin{highlightbar}
		\songsection{Refrain} \songsnippet{Ja, ich habe ein Problem mit Alkohol. Willst du mich verklagen? ...}
	\end{highlightbar}
	
	\songsection{Outro} \optionalChord{\footnotesize(\textit{N.C.})}
