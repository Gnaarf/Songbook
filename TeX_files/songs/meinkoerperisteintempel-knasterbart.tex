...
\begin{guitar}
	\songsection{Intro} {\footnotesize\begin{tabular}{l|l|l}
			G & C & (x4)
	\end{tabular}}
	\songsection{Strophe 1}\vspace{-0.2em}
	...
	\songsection{Refrain}\vspace{-0.2em}
	Denn mein [G]Körper ist ein Tempel, meine [C]Leber ist ein [G]Schrein
	Und um [C]alles gut zu [G]pflegen, trink' ich [D]täglich ein Glas Wein
	...
	\songsection{Bridge}\vspace{-0.2em}
