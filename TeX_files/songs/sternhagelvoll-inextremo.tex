...
\guitarchord{C}
\guitarchord{D}}
\strummingSixBeatsAndTwoMovementsPerBeat{d.dudud.dudu}

\begin{guitar}\begin{spacing}{0.95}
	\songsection{Intro}
	{\footnotesize\begin{tabular}{|c|c|c|l|}
			G & Cadd9 G & G & Dsus4 \\
	...
	[G]Durst ist schlimmer als [Dsus4]Heimweh,[\textit{N.C.}]{ was} kostet die Welt?
	...
	\end{highlightbar}\hfill\end{spacing}\end{guitar}