...
\begin{guitar}
	...
	\begin{highlightbar}
		...
		Die [C]Welt könnte so [D]schön sein – ohne [(G)]dich.
	\end{highlightbar}
	
	\songsection{Instrumental}
	{\footnotesize\begin{tabular}{|c|c|c|c|l}
			G & Bm & C & D & \optionalChord{(x2)}\\
			G & Bm & C & D & \optionalChord{(x2 mit Pfeifen)}
	\end{tabular}}
	...
	{\footnotesize\begin{tabular}{|c|c|c|c|l}
		G & Bm & C & D & \optionalChord{(x2)}\\
		G & Bm & C & D & \optionalChord{(x4 mit Pfeifen)} \\
		G & - & - & - &
	\end{tabular}}
\end{guitar}